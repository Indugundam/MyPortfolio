    ...
    >
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto">
          <h2 
            className={cn(
              "text-3xl font-bold mb-12 text-center text-primary transition-all duration-700",
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            <div 
              className={cn(
                "bg-card/80 backdrop-blur-sm border border-primary/10 p-8 rounded-2xl transition-all duration-700",
            ...
            >
              ...
              <ul className="space-y-6">
                <li className="relative pl-8 before:content-[''] before:absolute before:left-0 before:top-3 before:w-3 before:h-3 before:bg-primary before:rounded-full">
                  <h4 className="text-base font-medium">Bachelor's in Information Technology</h4>
                  <p className="text-sm text-primary font-medium mt-1">Gayatri Vidya Parishad College (2022-Current)</p>
                  <p className="text-sm text-muted-foreground mt-1">9.62 CGPA</p>
                </li>
                
                <li className="relative pl-8 before:content-[''] before:absolute before:left-0 before:top-3 before:w-3 before:h-3 before:bg-primary before:rounded-full">
                  <h4 className="text-base font-medium">Intermediate</h4>
                  <p className="text-sm text-primary font-medium mt-1">Narayana Junior College, Kurnool (2020-2022)</p>
                  <p className="text-sm text-muted-foreground mt-1">98.9%</p>
                </li>
                
                <li className="relative pl-8 before:content-[''] before:absolute before:left-0 before:top-3 before:w-3 before:h-3 before:bg-primary before:rounded-full">
                  <h4 className="text-base font-medium">Xth Grade</h4>
                  <p className="text-sm text-primary font-medium mt-1">Jyothi High School, Bandiātmakur (2020)</p>
